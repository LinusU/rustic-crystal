...
pub const JOHTO_WATER_WILD_MONS: &[(Map, WaterWildmons)] = &[
    ...
    (
        ...
        WaterWildmons {
            ...
            encounters: [
                (20, PokemonSpecies::Tentacool),
                (21, PokemonSpecies::Shellder),
                (22, PokemonSpecies::Tentacruel),
            ],
        },
    ),
    (
        ...
        WaterWildmons {
            ...
            encounters: [
                (20, PokemonSpecies::Tentacool),
                (21, PokemonSpecies::Horsea),
                (22, PokemonSpecies::Mantine),
            ],
        },
    ),
    (
    ...
    (
        ...
        WaterWildmons {
            ...
            encounters: [
                ...
                (24, PokemonSpecies::Poliwag),
                (28, PokemonSpecies::Poliwhirl),
            ],
        },
    ),
    (
